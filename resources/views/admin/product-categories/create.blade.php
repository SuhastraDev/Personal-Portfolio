...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900">Tambah Kategori Produk</h1>
</div>
    ...
    <form action="{{ route('admin.product-categories.store') }}" method="POST">
        ...
        <div class="p-6 space-y-4">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm" placeholder="contoh: Laravel Starter Kit">
            ...
            <div class="border-l-4 border-blue-400 pl-4">
                ...
                <input type="text" name="name_en" id="name_en" value="{{ old('name_en') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm" placeholder="e.g. Laravel Starter Kit">
