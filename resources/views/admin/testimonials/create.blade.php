    ...
    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-6 space-y-4">
            <div>
                ...
                <input type="text" name="client_name" id="client_name" value="{{ old('client_name') }}" required class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm">
            ...
            <div>
                ...
                <input type="text" name="client_role" id="client_role" value="{{ old('client_role') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm" placeholder="contoh: CEO, PT Maju Jaya">
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="4" required class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm">{{ old('content') }}</textarea>
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">JPG, PNG, atau WebP. Maks 2MB. Akan di-crop 200x200px.</p>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 rounded-b-xl flex justify-end gap-3">
            ...
            <button type="submit" class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm">Simpan Testimoni</button>
        </div>
    </form>
</div>
@endsection