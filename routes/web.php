...
Route::prefix('admin')->middleware(['auth', 'admin'])->name('admin.')->group(function () {
    ...
    Route::post('preferences/sync', [SettingController::class, 'ajaxUpdate'])->name('settings.ajax-update');
    Route::post('preferences/media', [SettingController::class, 'ajaxUpload'])->name('settings.ajax-upload');
